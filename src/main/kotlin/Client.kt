...
fun clampToMin(value: Int,min: Int, fallback: Int) = if (value >= 0) value else fallback
fun clampTo0(value: Int, fallback: Int) = clampToMin(value, 0, fallback)
fun clampToMax(value: Int,max: Int, fallback: Int) = if (value >= 0) value else fallback
